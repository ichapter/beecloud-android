...
public class BCPayTest {
     ...
     */
    @Test
    public void testReqAliInlineQRCodeAsyncParamInvalid() throws Exception {
        pay.reqAliInlineQRCodeAsync("billTitle",
                ...
                new BCCallback() {
                    ...
                    public void done(BCResult result) {
                        ...
                        Assert.assertEquals("returnUrl为ALI_QRCODE的必填参数，并且需要以http://或https://开始",
     ...
     */
    @Test
    public void testReqAliInlineQRCodeAsyncNetworkError() throws Exception {
        final BCHttpClientUtil.Response response = new BCHttpClientUtil.Response();
        response.code = 400;
     ...
     */
    @Test
    public void testReqAliInlineQRCodeAsyncErrorFromServer() throws Exception {
        final BCHttpClientUtil.Response response = new BCHttpClientUtil.Response();
        response.code = 200;
                ...
                new BCCallback() {
                    ...
                    public void done(BCResult result) {
                        ...
                        Assert.assertEquals((Integer) 16,
                                bcqrCodeResult.getResultCode());
                        Assert.assertEquals("RUNTIME_ERORR",
                                bcqrCodeResult.getResultMsg());
                        Assert.assertEquals("未知错误,请联系BeeCloud",
                                bcqrCodeResult.getErrDetail());
     ...
     */
    @Test
    public void testReqAliInlineQRCodeAsyncSucc() throws Exception {
        final BCHttpClientUtil.Response response = new BCHttpClientUtil.Response();
        response.code = 200;
        response.content = "{\"result_msg\":\"OK\",\"err_detail\":\"\",\"result_code\":0,\"html\":\"mocked html\",\"id\":\"a6c6a84e-7f86-4aba-9e0a-f3782d8bd960\",\"url\":\"mocked url\"}";
                ...
                new BCCallback() {
                    ...
                    public void done(BCResult result) {
                        ...
                        Assert.assertEquals((Integer) 0,
                                bcqrCodeResult.getResultCode());
                        Assert.assertEquals("mocked html",
                                bcqrCodeResult.getAliQRCodeHtml());
